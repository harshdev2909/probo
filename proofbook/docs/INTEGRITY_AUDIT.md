...
> Generated 2026-07-13T10:29:20.995Z by `npm run audit`.
...
|---|---|---|
| **VERIFIED_LIVE** | predicate read from chain, proof re-fetched from TxLINE, **TxLINE's own program re-adjudicated it by simulation and returned true** | **76** |
...
| Reconciliation — settled on chain == receipts in DB | ❌ FAIL | on chain but no DB receipt: 72; in DB but not settled on chain: 0 |
